...
public class VisualizacionCartas extends javax.swing.JDialog implements PanelCartasListener {

    
    public VisualizacionCartas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
